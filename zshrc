...
export ZSH="/home/geeofree/.oh-my-zsh"
...
# @@@ Variables for common directory paths
export pr="$HOME/Projects"
export no="$HOME/Documents/Notes"
export bo="$HOME/Documents/Books"

# @@@ FZF Related configurations
